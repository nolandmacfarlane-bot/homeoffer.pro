...
CREATE OR REPLACE FUNCTION public.is_homeoffer_owner(p_user_id uuid)
RETURNS boolean
LANGUAGE sql
STABLE
SECURITY DEFINER
...
BEGIN
  ...
  v_is_owner := coalesce(public.is_homeoffer_owner(p_agent_id), false);
