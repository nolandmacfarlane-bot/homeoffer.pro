      ...
      <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 w-full max-w-md">
        ...
        <div className="space-y-3 mb-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-gray-900 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-offset-2 text-white font-semibold py-3 rounded-lg transition disabled:opacity-50 min-h-12"
