...
export default function AgentDashboard() {
  ...
  return <main className="min-h-screen bg-gray-50 text-gray-950">
    <header className="border-b bg-white"><div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-5 px-5 py-7"><div><h1 className="text-3xl font-black">Listing agent dashboard</h1><p className="text-gray-600">Your listings, bidders, private maximums and activity.</p></div><div className="flex gap-3"><Link href="/agent/listing-builder" className="rounded-full bg-blue-600 px-6 py-3 font-bold text-white">Post a property</Link><Link href="/agent/profile" className="rounded-full border px-6 py-3 font-bold">Agent information</Link></div></div></header>
